...
class Server(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        json_string = json.dumps({"result":"ok"})
    ...
    def storeInSQL(self, df):
        ...
        keysLines = keysFile.readlines()
        mydb = connector.connect(host=keysLines[0],
                                 user=keysLines[1],
                                 passwd=keysLines[2],
                                 database=keysLines[3]) """
        ...
        #sqlFormula = """INSERT INTO location
        ...
        print('Success! Check your database.  Sending confirmation.')
        return True
